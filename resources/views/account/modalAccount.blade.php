<div class="modal fade" id="editModal{{ $account->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="/account-edit" method="POST">
                    ...
                    <div class="form-group  mb-3">
                        ...
                        <input type="text" class="formInput" name="id" placeholder="Enter amount"
                            value="{{ $account->id }}" hidden>
                    </div>
                    <div class="form-group  mb-3">
                        <label for="cashOutDebit">Date:</label>
                        <input type="date" class="formInput" name="date" value="{{ $account->date }}">
                    </div>
                    ...
                    <div class="form-group  mb-3">
                        ...
                        <input type="text" class="formInput" name="description"
