...
@section('content')
    ...
    <!-- ((((((((((((((((((((((((((((((((( InputParentDiv ))))))))))))))))))))))))))))))))) -->
    <div class="InputParentDiv flex-grow-1 p-3">
        <!-- account-table-section-1 -->
        ...
        <div class="account-table-section-2">
            ...
            <!-- selector section  -->
            <div class="form-group">
                <label1 for="date">Show Entries:</label1>
    ...
    <div>
        ...
        <form action="/account-store" method="POST" class="container mt-5  mb-5">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="cashOutDebit">CashOut Dr:</label>
                    <input type="text" class="formInput" id="cashOutDebit" placeholder="Enter amount"
                        name="cash_out" />
                </div>
                <div class="form-group">
                    <label for="cashInCredit">CashIn Cr:</label>
